...
public class BrowserUtils {
    private static VehicleOdometerPage vehicleOdometerPage;
    ...
    public static int getIndexOfElementFromList(List<WebElement> list, String elementsName) {
        int myIndex = -1;
        int i = 0;

        for (String element : BrowserUtils.getElementsText(list)) {
            if (element.equalsIgnoreCase(elementsName)) {
                myIndex = i;
                break;
            }
            i++;
    ...
    public static void theUserClicksButton(String buttonName) {
